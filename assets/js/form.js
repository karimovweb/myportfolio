...
document.querySelector(".form__btn").onclick = function () {
  ...
  let message = "Name:" + document.querySelector(".form__inp1").value + " ; " + "Email: "  + document.querySelector(".form__inp2").value + " ; " +  "Phone Number: " +  document.querySelector(".form__inp3").value + " ; " +  "Coment: " +  document.querySelector(".form__inp4").value + " ; ";
  console.log(message);
